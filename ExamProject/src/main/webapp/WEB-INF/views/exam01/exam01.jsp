				...
				<div class="card">
					...
					<div class="card-body">
						<form action="/exam01/insert2.do" method="post">
							<input type="text" name="memName_i" class="form-control" placeholder="이름을 입력해주세요."/><br/>
							<input type="text" name="memId_i" class="form-control" placeholder="아이디를 입력해주세요."/><br/>
							<input type="text" name="memPw_i" class="form-control" placeholder="비밀번호를 입력해주세요."/><br/>
							<button class="btn btn-primary">등록</button>
						</form>
					</div>
					<div class="card-footer">
		...
		<div class="row pt-4">
			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<form action="/exam01/insert4.do" method="post" enctype="multipart/form-data">
							<input type="text" name="memName" class="form-control" placeholder="이름을 입력해주세요."/><br/>
							<input type="text" name="memId" class="form-control" placeholder="아이디를 입력해주세요."/><br/>
							<input type="text" name="memPw" class="form-control" placeholder="비밀번호를 입력해주세요."/><br/>
