			...
			<div class="col-md-12">
				<div class="card card-dark card-outline">
						...
						<div class="card-tools">
							<form class="input-group input-group-sm" id="searchForm" style="width: 440px;">
								...
								<select class="form-control" name="searchType">
									<option value="title" <c:if test="${searchType eq 'title' }"></c:if>>제목</option>
									<option value="writer" <c:if test="${searchType eq 'writer' }"></c:if>>작성자</option>
								</select> 
									...
									<c:otherwise>
										<c:forEach items="${noticeList }" var="noticeVO">
											<tr>
												...
												<td>
													<font class="badge badge-danger" 
													style="font-size: 14px;">${noticeVO.boWriter }</font>
												</td>
					...
					<div class="card-footer" align="right">
						<button type="button" class="btn btn-dark" id="insBtn">등록</button>
					</div>
...
$(function(){
	...
	var insBtn = $("#insBtn");			// 등록 페이지로 이동하기 위한 버튼
