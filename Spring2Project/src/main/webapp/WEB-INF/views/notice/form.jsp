				...
				<form action="/notice/insert.do" method="post" id="noticeForm" enctype="multipart/form-data">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" id="boTitle"
							 name="boTitle" class="form-control" value="${noticeVO.boTitle }" placeholder="제목을 입력해주세요">
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div class="col-12">
								...
								<c:if test="${status ne 'u' }">
									<input type="button" value="목록" id="listBtn"  class="btn btn-dark float-right" >
								</c:if>
							</div>
						</div>
					</div>
...
// 		var content = $("#boContent").val();	// 일반적인 input 요소를 이용한 값 가져오기
		var content = CKEDITOR.instances.boContent.getData();	// CKEDITOR를 이용한 값 가져오기
