...
$(function(){
	...
	inputFile.on("change", function(event){
		...
		if(isImageFile(file)){	// 이미지 파일 일 때
			// 비동기 처리 시, 파일 데이터를 전송할때에는 FormData()를 이용하여 데이터를 전송한다.
			...
			// 				이때 파일 전송의 경우 쿼리스트링을 사용하지 않으므로 해당 설정을 false로 비활성화한다.
			// contentType : Content-Type을 설정 시, 해당 설정의 기본값은 'application/x-www-form-urlencoded; charset=utf-8'
			...
			// 				그렇게되면 ContentType의 형태가 'multipart/form-data'로 나간다.
