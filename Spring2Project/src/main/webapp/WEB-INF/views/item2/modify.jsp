	...
	<form action="/item2/modify" method="post" enctype="multipart/form-data">
		...
		<table border="1">
			...
			<tr>
				<td>파일</td>
				<td>
					<img src="/item2/display?itemId=${item.itemId }" width="210" height="240" alt="${item.pictureUrl }">
				</td>
			</tr>
			<tr>
				<td>파일</td>
			...
			<tr>
				<td>파일2</td>
				<td>
					<img src="/item2/display2?itemId=${item.itemId }" width="210" height="240" alt="${item.pictureUrl2 }">
				</td>
			</tr>
			<tr>
				<td>파일2</td>
