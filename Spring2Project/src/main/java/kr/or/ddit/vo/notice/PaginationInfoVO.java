...
public class PaginationInfoVO<T> {
	...
	public void setTotalRecord(int totalRecord) {
		// 총 게시글수를 저장하고, 총 게시글 수를 페이지 당 나타탤 게시글 수로 나눠 총 페이지수를 구한다.
	...
	public void setCurrentPage(int currentPage) {
		...
		// '/blockSize * blockSize는 1, 2, 3, 4, 5... 페이지 마다 실수 계산이 아닌 정수 계산을 이용해 endPage를 구하기 위함.
	...
	public String getPagingHTML() {
		...
		// endPage 만큼 반복되고 넘어가야할 페이지가 존재하지 않는 상태라면 마지막 페이지가 포함되어 있는 block 영역이므로
		// totalPage 만큼 반복됩니다.
