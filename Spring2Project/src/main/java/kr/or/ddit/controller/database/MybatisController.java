...
public class MybatisController {
	 ...
	 * 					최신의 boardNo를 생성하고 생성된 boardNo를 sql쿼리가 담겨있는 insert 태그까지 넘어올 때 넘겨주고 있는 파라미터(board)
	 * 					의 property인 boardNO에 셋팅한다.
	 * 					셋팅된 boardNo를 아래 insert 쿼리 동작 시 등록 값으로 사용하고 board라는 자바빈즈 객체에 담겨 최종 컨트롤러까지 넘어간다.
	 * 
