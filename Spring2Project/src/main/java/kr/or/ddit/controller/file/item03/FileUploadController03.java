...
public class FileUploadController03 {
	 ...
	 * 	4. 비동기 방식 업로드
	 * 
	 * 		- 비동기 방식으로 여러 개의 이미지 업로드 하는 파일 업로드 기능을 구현한다.
	 * 
	 * 			# 환경 설정
	 * 
	 * 				- 의존 관계 정의 (pom.xml)
	 ...
	 * 				- 파일업로드 등록화면 컨트롤러 메소드 만들기 (item3RegisterForm:get)
	 * 				- 파일업로드 등록화면 만들기 (itme3/register.jsp)
	 * 				- 여기까지 확인
	 * 
	 * 
	 * 				- 파일업로드 등록 기능 컨트롤러 메소드 만들기 (item3Register:post)
	 * 				- 파일업로드 등록 기능 서비스 인터페이스 메소드만들기
	 ...
	 * 				- 여기까지 확인
	 * 
	 * 				- 파일업로드 목록 기능 컨트롤러 메소드 만들기 (item3List:get)
	 ...
	 * 				- 여기까지 확인
	 * 
	 * 				- 파일업로드 수정 화면 기능 컨트롤러 메소드 만들기 (item3ModifyForm:get)
	 * 				- 파일업로드 수정 화면 기능 서비스 인터페이스 메소드 만들기
	 * 				- 파일업로드 수정 화면 기능 서비스 클래스 메소드 만들기
	 * 				- 파일업로드 수정 화면 기능 Mapper 인터페이스 메소드 만들기
	 * 				- 파일업로드 수정 화면 기능 Mapper xml 쿼리 만들기
	...
	@GetMapping("/modify")
	public String item3ModifyForm(Model model, int itemId) {
		Item3 item = itemService.read(itemId);
		model.addAttribute("item", item);
		// item3_attach 테이블에서 fullname들의 목록 데이터를 리턴
		return "item3/modify";
	}
