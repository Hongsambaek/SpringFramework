...
public class JSTLHomeController {
	 ...
	 * 		<c:forToekns>	| 구분자로 구분된 각각의 토른클 처리할 때 사용한다.
	 ...
	 * 		<fn:containsIgnoreCase>	| 지정한 문자열이 대문자/서문자를 구분하지 않고 포함돼 있는지 판단한다.
	 ...
	 * 		scope		|	String		| 변수를 저장할 영역
	 * 		───────────────────────────────────────────────────────────────────
	 * 		value 속성값의 두가지 타입 (절대 URL과 상대 URL)
	 * 			- 절대 URL : 완전한 URL이다.
