...
public class LoginInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		String requestURL = request.getRequestURL().toString(); // http://localhost/~~
		...
		log.info("Bean : " + method.getBean()); // kr.or.ddit.controller.login.loginController@2341eu234
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		if(member != null && !((CrudMember)member).getUserId().equals("")) {
			...
			if(requestURI.equals("/intercept/login") && request.getMethod().equals("POST")) {
