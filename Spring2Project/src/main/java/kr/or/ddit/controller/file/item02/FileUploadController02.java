...
public class FileUploadController02 {
	...
	public String item2Register(Item2 item, Model model) throws Exception, Exception {
		...
		for(int i = 0; i < pictures.size(); i++) {
			...
			if(i == 0) {	// 첫 번째 파일의 URL 정보
				item.setPictureUrl(savedName);
				
			} else { 		// 두 번째 파일의 URL 정보
