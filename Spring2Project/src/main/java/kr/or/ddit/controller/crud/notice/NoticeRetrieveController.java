...
public class NoticeRetrieveController {
	...
	// 스프링 시큐리티 적용(ROLE_MEMBER, ROLE_ADMIN만 접근 가능)
	...
	public String noticeList(
		...
		// 총 게시글 수를 이용하여 총 페이지수를 결정하기 위해 총 게시글 수인totalRecord를 얻어온다.
		int totalRecord = noticeService.selectNoticeCount(pagingVO);
		// totalPage를 결정한다.
		pagingVO.setTotalRecord(totalRecord);
		// 총 게시글 수 및 총 페이지 수, startRow, endRow의 값들을 이용하여 초기 1페이지에 들어있는 총 screenSize 개수만큼의
		// 리스트 데이터를 가져온다.
